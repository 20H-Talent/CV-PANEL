        ...
        <div class="container">
            <div class="row">
                ...
                <td class="options text-center">
                    ...
                    <button type="button" title="Delete company"  class="my-2 btn  remove-company  btn-sm  btn-outline-danger "  data-toggle="modal" data-id=${this.companies[i].id} data-target="#confirm-delete" onclick="removeCompanyFromDOM(${this.companies[i].id})"><i class="far fa-trash-alt"></i></button></td>
                </tr>`);
        }
    };
