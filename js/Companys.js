      ...
      $("#tableBody").append(`<tr scope="row">
                <td class="company-logo user-avatar  pl-5"><img class="img text-center align-middle"src=${
                  this.companies[i].logo
                      ...
                      <td class="company-registered">${
                        this.companies[i].socialnetworks.facebook
                      }</td>
                      </td>
                      <td class="options text-center">
                          <button  type="button" onclick=" ${this.companies[
                            i
                          ].showInfo()}" class="btn btn-danger" data-toggle="modal" data-target="#ordine"><i class="far fa-eye"></i></button>
