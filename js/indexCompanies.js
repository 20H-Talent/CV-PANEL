...
function showPreviewInfo(id) {
    ...
    $("#modal").html(
        `<div class="shadow-lg p-3 border col-lg col-sm  col-md  rounded"   data-id=${company.id} >
        ...
        <div class="text-light">
            <div class=" text-dark text-center mt-3 h6"><h6 class="  text-center rounded  header-card text-white">Email</h6><p><a class="text-dark text-center" href="mailto${company.email}">${company.email}</a></p>
        </div>
